      ...
      >
        ...
        <div className="mt-4">
          ...
          <select
            ...
            className="font-mono w-full max-w-[200px] min-h-[44px] touch-target border-b border-border bg-transparent py-3 text-base text-text-primary outline-none md:py-2 md:text-sm"
          >

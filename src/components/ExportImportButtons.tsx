...
export function ExportImportButtons() {
  ...
  return (
    <>
      ...
      <div className="pointer-events-auto fixed z-[1100]" style={{ top: 'calc(max(1.5rem, env(safe-area-inset-top, 0px)) + 17.5rem)', right: 'max(1.5rem, env(safe-area-inset-right, 0px))' }}>
        <button
          type="button"
          onClick={(e) => {
            e.preventDefault();
          ...
          aria-haspopup="true"
        >
          <svg width="22" height="22" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className={exportOpen ? 'text-accent' : 'text-text-secondary'}>
      ...
      <button
        ...
        style={{ top: 'calc(max(1.5rem, env(safe-area-inset-top, 0px)) + 21rem)', right: 'max(1.5rem, env(safe-area-inset-right, 0px))' }}
      ...
      {importError && (
        <p
          ...
          style={{ top: 'calc(max(1.5rem, env(safe-area-inset-top, 0px)) + 25rem)', right: 'max(1.5rem, env(safe-area-inset-right, 0px))' }}
          role="alert"
        >
          {importError}
        </p>
